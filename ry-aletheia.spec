...
datas = [('autodrive_console/web', 'autodrive_console/web'), ('autodrive_console/web-vue', 'autodrive_console/web-vue'), ('/home/bob/Desktop/ry_aletheia_v2/ry-aletheia/config/video.shm.json', 'config/video.json'), ('/tmp/tmp.Tpnjabq5Ae/runtime', 'runtime/video')]
