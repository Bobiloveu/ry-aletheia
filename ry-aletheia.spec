...
datas = [('autodrive_console/web', 'autodrive_console/web'), ('autodrive_console/web-vue', 'autodrive_console/web-vue'), ('config/video.json', 'config'), ('/tmp/tmp.f2nkueWhMU/runtime', 'runtime/video')]
