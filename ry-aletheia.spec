...
datas = [('autodrive_console/web', 'autodrive_console/web'), ('autodrive_console/web-vue', 'autodrive_console/web-vue'), ('config/video.json', 'config'), ('/tmp/tmp.C4NE6XJ7bo/runtime', 'runtime/video')]
